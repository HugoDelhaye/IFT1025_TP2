...
/**
 La classe Server implémente un server qui permet l'exécution de 2 commande : INSCRIRE et CHARGER
 */
public class Server {
    /**
    ...
    /**
     ...
     @param h       Le Evenethandler qui sera ajout  à l'ArrayList handlers.
     */
    ...
    /**
     Lance une boucle qui appelle chacun sont tour les EventHandlers de l'ArrayList handlers.
    ...
    /**
     Méthode qui sera appellée dans le launcher pour démarer le server, définis le comportement du server.
     */
    public void run() {
        while (true) {
            try {
    ...
    /**
     Récupère la ligne de commande envoyée par le client sous forme de String.
    ...
    /**
     ...
     @return Pair<String, String>       Contient la commande et les arguments.
     */
    ...
    /**
     Détermine si la méthode handleRegistration ou handleLoadCourses selon de l'argument cmd.
