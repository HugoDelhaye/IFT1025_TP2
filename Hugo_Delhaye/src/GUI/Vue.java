...
public class Vue extends HBox{
    ...
    //#####Partie du bas#####
    /**
     Boutton utilisé pour charger unr liste de cours.
     */
    ...
    /**
     Retourne un String [] contenant les valeurs de getTextFieldPrenom(), getTextFieldNom(),
     getTextFieldEmail(), getTextFieldMatricule().

     @return    Un String [] contenant les valeurs de getTextFieldPrenom(), getTextFieldNom(),
     getTextFieldEmail(), getTextFieldMatricule()
     */
    ...
    /**
     Créer un String énumérant les erreurs de l'étudiant lorsqu'il a remplie les TextField pour s'incrire
